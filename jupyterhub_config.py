...
#c.JupyterHub.data_files_path = '/anaconda3/envs/hubspace/share/jupyterhub'
...
c.Authenticator.admin_users = {'af'}
...
c.Spawner.cmd = ['jupyter', 'labhub', '--LabApp.dev_mode=True']
